        ...
        <div className="bg-background">
          ...
          <div className="flex gap-2 items-center">
            <div className="flex gap-2 items-center">
              ...
              <Select value={gameType ?? ""} onValueChange={(value) => setGameType(value)}>
            ...
            <div className="flex gap-2 items-center">
              ...
              <Select value={roomName ?? ""} onValueChange={(value) => setRoomName(value)}>
                <SelectTrigger className="w-28">
                  <SelectValue placeholder={t("placeholderselect")} />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="flex gap-2 items-center">
              ...
              <Input placeholder={t("placeholderinput")}  value={gameId ?? ""}onChange={(e) => setGameId(e.target.value)}/>
            </div>
            <div className="flex gap-2 items-center">
