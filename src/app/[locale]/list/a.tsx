...
import { ChevronDown, ChevronRight, GamepadIcon, RotateCwIcon, UsersIcon } from "lucide-react";
            ...
            <CardContent className="p-0">
                <div className="bg-gray-50 dark:bg-gray-800 p-4 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        >
                            {expandedRows[game.id] ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
                        </Button>
                        <GamepadIcon size={20} />
                    ...
                    <CardContent className="p-0">
                        <div className="bg-blue-50 dark:bg-blue-900 p-3 flex items-center">
                            <Button
                                ...
                                className="mr-2"
                            >
                                {expandedRows[round.id] ? <ChevronDown size={14} /> : <ChevronRight size={14} />}
                            </Button>
