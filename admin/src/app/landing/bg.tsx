...
export function Bg() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[20dvh] z-10 flex w-full items-center justify-center gap-2 *:data-[current=true]:w-5 *:data-[current=true]:border *:data-[current=true]:bg-slate-300">
        <div
