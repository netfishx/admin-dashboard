        ...
        >
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <Label className="w-[100px] shrink-0 text-right text-muted-foreground before:mr-1 before:text-destructive before:content-['*']">
                {t("oldPassword")}
              </Label>
              <Password
                type="password"
            ...
            <div>
              ...
              <div className="mt-2 ml-[110px] text-destructive text-xs">
                {t("passwordWarning")}
              </div>
            </div>
            <div className="flex items-center gap-2">
